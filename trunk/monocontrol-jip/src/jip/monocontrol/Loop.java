...
public class Loop {
	...
	public void loadJDOMXMLElement(Element xmlLoop)
	{
		...
		startOffset = xmlLoop.getAttributeValue("startOffset") == null ? Looper.NOT_SET : Integer.parseInt(xmlLoop.getAttributeValue("startOffset"));
		resCounter = xmlLoop.getAttributeValue("resCounter") == null ? Looper.NOT_SET : Integer.parseInt(xmlLoop.getAttributeValue("resCounter"));
		pressedRow = xmlLoop.getAttributeValue("pressedRow") == null ? Looper.NOT_SET : Integer.parseInt(xmlLoop.getAttributeValue("pressedRow"));
